...
| 1 | Catalog.API | **In progress** — 1.1–1.5 done, 1.6–1.7 pending |
...
Local UIs: Catalog API reference (Scalar) `http://localhost:5124/scalar` · RabbitMQ management `http://localhost:15672` (guest/guest) · Jaeger `http://localhost:16686`
