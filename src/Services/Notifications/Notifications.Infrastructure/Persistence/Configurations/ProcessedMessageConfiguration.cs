...
internal sealed class ProcessedMessageConfiguration : IEntityTypeConfiguration<ProcessedMessage>
{
    public void Configure(EntityTypeBuilder<ProcessedMessage> builder)
    {
        ...
        //
        // En Inventory (3.6) y Payments esta clave nació hipotética, con un solo
        // consumer en el servicio. **Aquí no**: Notifications estrena dos consumers
        // el mismo día, así que la tabla tiene dos ConsumerName distintos desde la
        // primera fila. Es el mismo caso que Orders estrenó en 4.3.
        //
