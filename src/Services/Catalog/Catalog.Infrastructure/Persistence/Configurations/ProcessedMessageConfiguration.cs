...
/// cuatro servicios. Todo está declarado a mano aunque parte coincida con las
...
internal sealed class ProcessedMessageConfiguration : IEntityTypeConfiguration<ProcessedMessage>
{
    public void Configure(EntityTypeBuilder<ProcessedMessage> builder)
    {
        ...
        //
        // Aquí nace hipotética otra vez —Catalog estrena un solo consumer—, como
        // en Inventory (3.6) y Payments (3.5), y al contrario que en Notifications
        // (4.6) y Orders (4.3), que estrenaron dos. Se pone compuesta igual:
        // cambiar una PK con la tabla ya poblada es una migración, no una línea.
        //
        ...
        // literales aquí — la regla que Catalog fijó en 1.3 y que este archivo
        // hereda al llegar por fin al servicio que la escribió.
        //
