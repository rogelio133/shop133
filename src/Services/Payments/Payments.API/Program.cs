...
// hace de momento es conectarse al broker. El consumer de StockReserved y el
// cobro simulado llegan en 3.5.
//
...
// El bloque es una copia literal del de Orders.API e Inventory.API, y eso es
...
builder.Services.AddMassTransit(x =>
{
    ...
    // cambiarlo en 3.5 dejaría colas huérfanas en el broker que nadie vacía.
    //
    ...
    x.UsingRabbitMq((context, cfg) =>
    {
        ...
        // línea que 3.5 espera encontrar — sin ella, registrar un IConsumer no
