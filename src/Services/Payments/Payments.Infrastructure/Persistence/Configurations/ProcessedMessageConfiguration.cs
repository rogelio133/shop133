...
internal sealed class ProcessedMessageConfiguration : IEntityTypeConfiguration<ProcessedMessage>
{
    public void Configure(EntityTypeBuilder<ProcessedMessage> builder)
    {
        ...
        //
        // Hoy Payments tiene un consumer y la clave compuesta parece de más. En
        // cuanto haya un segundo la tabla ya tendría filas — cambiar la PK
        // después es una migración con datos dentro, no una línea.
        //
